...
@section ('content') 
    ...
    <div class="w3-services py-4">
        ...
        <div class="container py-lg-4">
            <div class="title-content text-center mb-lg-2 mb-2">
                <h6 class="sub-title">Simulasi Kredit</h6>
            </div>
            <div class="row w3-services-grids">
                <div class="col-lg-12 col-md-6 causes-grid">
                    <div class="causes-grid-info">

                        <img class="img-fuild" alt="" src="https://toyota-cilegon-serang.id/assets/upload-files/halaman/simulasi_Kredit_Avanza_Veloz_2019.png" alt="">
