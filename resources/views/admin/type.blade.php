...
@section('content')
    <div class="container mt-5">
        <h1 class="mb-4 text-center">List Data Type</h1>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Form Type</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <form id="formCRUD" method="POST" action="{{ route('admin.type.create') }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('.my-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.type.datatable') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        width: '5%',
